...
// 给instance上的myProperty属性定义元数据，属性是key1，值是value1
...
// 获取自有元数据(针对方法)
const ownMetaDataValue1 = Reflect.getOwnMetadata(
  "customKey",
  Reflect.getPrototypeOf(instance),
  "myMethod"
)
console.log(`Own Metadata customKey value for myMethod: ${ownMetaDataValue1}`)
const ownMetaDataValue2 = Reflect.getOwnMetadata(
  "customKey",
  MyClass.prototype,
  "myMethod"
)
...
const hasMetadataAfterDelete = Reflect.hasMetadata(
  "key1",
  instance,
  "myProperty"
)
console.log(
  `Has Metadata key1 for myProperty after delete: ${hasMetadataAfterDelete}`
)
